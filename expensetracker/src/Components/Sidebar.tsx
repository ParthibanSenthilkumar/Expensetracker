...
const Sidebar = () => {
  ...
  return (
    ...
    <div className="wrapper flex items-stretch min-h-screen">
        <div className="sidebar min-h-screen max-w-[250px] w-full p-3 bg-[#e2eafc]">
        ...
        <div className="top_bar flex items-start  justify-between px-4 py-5">
            <div className="head"> 
                <h3 className="text-3xl text-gray-950 font-bold font-heading">Welcome</h3>
                <p className="text-sm text-gray-500 font-secondary">Track your income and expenses, manage your budget, and stay on top of your finances.</p>
            </div>
