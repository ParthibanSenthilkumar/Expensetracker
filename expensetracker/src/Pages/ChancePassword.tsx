    ...
    <>
      <div className="shadow-custom1 p-5 space-y-6">
        ...
        <div className="form-item flex items-start gap-3 ">
          ...
          <div className="w-full">
            ...
            <input
              type="password"
              name="CurrenPassword"
              className='className="w-full h-12 px-5 rounded-xl border border-gray-200 bg-gray-50 text-gray-600 font-medium outline-none"'
        ...
        <button
          ...
          className="border-2 border-blue-500 hover:bg-indigo-200 text-sm font-heading font-semibold px-6 py-2 text-blue-600  rounded-lg transition bg-bule-50 flex items-center gap-2.5"
        >
          {" "}
          <span>
